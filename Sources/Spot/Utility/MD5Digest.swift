...
//  Spot
//
//  Created by Shawn Clovie on 7/6/2017.
...
struct MD5Digest {
	...
	static func create(_ str: String) -> MD5Digest {
		md5([Byte](str.utf8))
	}
...
private func rotateLeft(_ x: Word, by: Word) -> Word {
	((x << by) & 0xFFFFFFFF) | (x >> (32 - by))
}

// MARK: - Calculating a MD5 digest of bytes from bytes
private func md5(_ bytes: [Byte]) -> MD5Digest {
	// Initialization
	let s: [Word] = [
